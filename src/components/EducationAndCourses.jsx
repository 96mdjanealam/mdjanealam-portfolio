    ...
    <div className="bg-[#00BF83]/20 py-10 md:py-20">
      <div className="w-[90%] md:w-[80%] mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          {courses.map((course) => (
            <div key={course.id} className="card bg-base-100 shadow-md border-2 border-success relative">
                <h2 className="absolute right-4 top-2 font-bold text-3xl opacity-30 text-success">{course.year}</h2>
              <div className="card-body flex-row ">
                <div className="w-[20%] flex-shrink-0">
                  <img src={course.image} className="w-full object-contain pr-4" alt={course.title} />
                </div>
                <div className="w-[80%]">
